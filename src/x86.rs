...
struct InterruptInfo {
    ...
    // alignment check done by FXSAVE / FXRSTOR
...
inthandler_common:
    // General purpose registers (expect rsp and rcx)
    push r15
    push r14
    push r13
    push r12
...
#[no_mangle]
extern "sysv64" fn init_handler_unimplemented() {
...
/// # Safety
/// This function modifies the page table as callback does, do
